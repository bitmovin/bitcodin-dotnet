...
{
    public static class CreateWatermarkedVideoJob
    {
        public static void Run()
        {
            ...
            /* CREATE WATERMARK */
            var watermarkConfig = new WatermarkConfig
            {
                Right = 10,
                Top = 100,
                Image = "http://bitdash-a.akamaihd.net/webpages/bitcodin/images/bitcodin-bitmovin-logo-small.png"
            };
            // Watermark will be placed with a distance of 200 pixel to the Right of the input video
            // Watermark will be placed with a distance of 100 pixel to the Top of the input video
