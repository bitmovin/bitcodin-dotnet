...
{
    public static class CreateMultiAudioStreamJob
    {
        public static void Run()
        {
            ...
            var audioStreamConfigSoundHigh = new AudioStreamConfig
            {
                Bitrate = 256000,
                DefaultStreamId = 0
            };
            encodingProfileConfig.AudioStreamConfigs.Add(audioStreamConfigSoundHigh);

            var audioStreamConfigSoundLow = new AudioStreamConfig
            {
                Bitrate = 128000,
                DefaultStreamId = 0
            };
            encodingProfileConfig.AudioStreamConfigs.Add(audioStreamConfigSoundLow);

            var audioStreamConfigSoundAndVoiceHigh = new AudioStreamConfig
            {
                Bitrate = 256000,
                DefaultStreamId = 1
            };
            encodingProfileConfig.AudioStreamConfigs.Add(audioStreamConfigSoundAndVoiceHigh);

            var audioStreamConfigSoundAndVoiceLow = new AudioStreamConfig
            {
                Bitrate = 128000,
                DefaultStreamId = 1
            };
            encodingProfileConfig.AudioStreamConfigs.Add(audioStreamConfigSoundAndVoiceLow);
            ...
            var audioMetaDataJustSound = new AudioMetaData
            {
                DefaultStreamId = 0,
                Label = "Just Sound",
                Language = "de"
            ...
            var audioMetaDataSoundAndVoice = new AudioMetaData
            {
                DefaultStreamId = 1,
            ...
            jobConfig.AudioMetaData = new AudioMetaData[2];
            jobConfig.AudioMetaData[0] = audioMetaDataJustSound;
            jobConfig.AudioMetaData[1] = audioMetaDataSoundAndVoice;
