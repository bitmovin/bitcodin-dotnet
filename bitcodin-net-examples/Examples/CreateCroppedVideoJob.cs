...
{
    public static class CreateCroppedVideoJob
    {
        public static void Run()
        {
            ...
            /* CREATE CROP CONFIG */
            var croppingConfig = new CroppingConfig
            {
                Bottom = 100, // 100 pixel of the bottom from the input video will be cropped, before encoding starts.
                Top = 100, // 100 pixel of the top from the input video will be cropped, before encoding starts.
                Right = 200, // 5 pixel of the right side from the input video will be cropped, before encoding starts.
                Left = 55 // 55 pixel of the left side from the input video will be cropped, before encoding starts.
            };
